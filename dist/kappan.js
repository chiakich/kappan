...
var inkEqOf = (p) => clamp(1 - Math.max(0, 1 - p.ink) + Math.max(0, p.ink - 1) + Math.max(0, p.pressure - 1) * 0.6, 0, 2);
var common = (p, d, fill) => ({
  ...
  bleed: p.paper >= 0.5 || inkEqOf(p) >= 1.3 ? 5 : false,
